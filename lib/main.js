...
function send()
{
 ...
 var area6 = prior.options[prior.selectedIndex].value;
 ...
 if(sql && (area6 > '0' && area4 != '' && area3 != '' && area2 != '' && area1 != ''))
 {
 document.getElementById("ajaximg").style.visibility = "visible";
 $.ajax({
	type: "POST",
	data: "a1="+area1+"&a2="+area2+"&a3="+area3+"&a4="+area4+"&a5="+area5+"&a6="+area6+"&sql="+sql,
	url: "send.php",
	cache: false,
	success: function(html)
		{
