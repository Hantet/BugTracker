	...
	!empty($_POST['string']))
{
	...
	while($row=$sql->fetch($result))
	{
		...
		$text.= '
		<tr>
		 <td width="16" valign="top"><div style="cursor:pointer;" onClick=\'document.getElementById("name").value="'.$name.'";searchresult('.$entry.');\' title="Добавить"><img src="img/add.png"></div></td>
